...
function App() {
  ...
  return (
    ...
    <div>
      <button className='px-4 rounded-full bg-blue-200' onClick={() =>{ filterYears(10)
         setData(initialData)}}>last 10 years</button>
      <button className='px-4 rounded-full bg-blue-200' onClick={() => filterYears(20)}>last 15 years</button>
    </div>
    <div className='flex'>
